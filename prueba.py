...
def main():
    ...
    # Cargar el DataFrame
    df = cargar_dataframe("https://raw.githubusercontent.com/Frank10OC/prueba/main/Reporte_Proyecto_APROBADO%20(4).csv")  # Función para cargar el DataFrame, puedes adaptarla según tus necesidades
